...
class CheckVideos extends ModelDefinition {
    ...
    private function initConexion(&$conx)
    {
        ...
        $this->query->CheckVideosQuery();
    }

    public function getItem($id)
    {
        $query = $this->query->queryList['CheckVideos']['getItem'];
        $data = array(
            "[[id]]" => $id
        );
    ...
    {
        $query = $this->query->queryList['CheckVideos']['getAllItems'];
    ...
    public function insertItem(array $data)
    {
        ...
        if(isset($video) && is_numeric($video) && isset($infante) && is_numeric($infante)){
            $query = $this->query->queryList['CheckVideos']['insertItem'];
            $insert = array(
                "[[video]]" => $video,
				"[[infante]]" => $infante
            );
    ...
    {
        $query = $this->query->queryList['CheckVideos']['updateItem'];
        $replace = "";
    ...
    {
        $query = $this->query->queryList['CheckVideos']['deleteItem'];
        $data = array(
            "[[id]]" => $id
        );
    ...
    {
        $query = $this->query->queryList['CheckVideos']['getLastItem'];
