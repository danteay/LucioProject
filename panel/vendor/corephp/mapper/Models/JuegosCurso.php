...
class JuegosCurso extends ModelDefinition {
    ...
    private function initConexion(&$conx)
    {
        ...
        $this->query->JuegosCursoQuery();
    }

    public function getItem($id)
    {
        $query = $this->query->queryList['JuegosCurso']['getItem'];
        $data = array(
            "[[id]]" => $id
        );
    ...
    {
        $query = $this->query->queryList['JuegosCurso']['getAllItems'];
    ...
    {
        $query = $this->query->queryList['JuegosCurso']['getAllItemsByCurso'];
        $insert = array(
            "[[id]]" => $id
        );
    ...
    public function insertItem(array $data)
    {
        ...
        if(isset($path) && !empty($path) && isset($titulo) && !empty($titulo) && isset($curso) && is_numeric($curso)){
            $query = $this->query->queryList['JuegosCurso']['insertItem'];
            $insert = array(
                "[[path]]" => $path,
				"[[titulo]]" => $titulo,
				"[[curso]]" => $curso
    ...
    {
        $query = $this->query->queryList['JuegosCurso']['updateItem'];
        $replace = "";
    ...
    {
        $query = $this->query->queryList['JuegosCurso']['deleteItem'];
        $data = array(
            "[[id]]" => $id
        );
    ...
    {
        $query = $this->query->queryList['JuegosCurso']['getLastItem'];
