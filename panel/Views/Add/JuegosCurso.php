...
<head>
    <meta charset="UTF-8">
    <title>Nuevo Juego de Curso</title>
...
<main>
    ...
    <?php if($flag){ ?>
        ...
        <div class="row">
            <div class="large-12 columns">
                <div class="callout">
                    <form id="addform" action="../../Controllers/Add/JuegosCursoController.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="large-12 columns">
                                <label for="">
                                    Titulo
